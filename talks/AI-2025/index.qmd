...
:::{.r-stack}
* GitHub Copilot {{< iconify ri copilot-fill >}} + VS Code {{< iconify nonicons vscode-16 >}}
* ChatGPT Canvas {{< iconify logos openai-icon >}}
* Adobe Firefly {{< iconify ic sharp-adobe >}} + Photoshop {{< iconify devicon-plain photoshop >}}
* Adobe Firefly Video {{< iconify ic sharp-adobe >}} + Premiere Pro {{< iconify devicon-plain premierepro >}}
